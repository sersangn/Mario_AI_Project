...
def make_action(screen, info, step, env, prev_action):
    ...
    if len(enemy_locations) >0:
        if enemy_locations[0][0][0] - mario_locations[0][0][0] == 40 :
            action = 2
            return action 
    # if len(block_locations) >0:
    #     if block_locations[0][0][0] - mario_locations[0][0][0] == 60 :
    #         action =2
    #         return action 
    # if mario_locations - enemy_location == 0:
    #     action = 2
    #     return action
    #-----longer jump press A button for more frames
    ...
    if step % 10 == 0: #----does things for ten frames
